...
class ChangeItem extends StatefulWidget {
  @override
...
class _AddItemState extends State<ChangeItem> {
      ...
      body: Padding(
        padding: const EdgeInsets.fromLTRB(10,0,10,0),
          child: Column(
            ...
            children: [
              Text("Change Item",style: TextStyle(fontSize: 20.0),),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: [
                        Padding(
                          padding: const EdgeInsets.fromLTRB(10,10.0,0,0),
                          child: Text("Category:",style: TextStyle(fontSize: 17.0),),
                        ),
                        DropdownButton<Item>(
